...
class NetworkListener: NSObject, ObservableObject, CBPeripheralManagerDelegate {
    ...
    func start() {
        // Initialize peripheral manager. CBPeripheralManager delegate will be notified
        // of state changes, starting advertising when powered on.
    ...
    func peripheralManagerDidUpdateState(_ peripheral: CBPeripheralManager) {
        ...
        case .poweredOff:
            ...
            stopAdvertising()
        case .unauthorized:
            print("Bluetooth Peripheral unauthorized. Please grant Bluetooth permissions.")
    ...
    private func setupService() {
        ...
        // Properties: writeWithoutResponse (fast mouse moves) & write (actions/clicks with response)
    ...
    private func startAdvertising() {
        ...
        let advertisingName = "MouseServer: \(macName)"
    ...
    func peripheralManagerDidStartAdvertising(_ peripheral: CBPeripheralManager, error: Error?) {
        DispatchQueue.main.async {
            if let error = error {
                ...
                print("Advertising started successfully as '\(self.publishedServiceName)'")
